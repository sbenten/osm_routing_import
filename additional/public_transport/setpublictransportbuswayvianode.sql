CREATE FUNCTION setpublictransportbuswayvianode(way_id integer, source_geom public.geometry, target_geom public.geometry, vianode integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
/*
...
vianode	integer	Base network vertex identifiers to route through				
...
ALTER FUNCTION setpublictransportbuswayvianode(way_id integer, source_geom public.geometry, target_geom public.geometry, vianode integer) OWNER TO postgres;