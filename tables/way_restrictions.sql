-- Sequence: import.way_restrictions_id_seq

-- DROP SEQUENCE import.way_restrictions_id_seq;

CREATE SEQUENCE import.way_restrictions_id_seq
  INCREMENT 1
  MINVALUE 1
  MAXVALUE 9223372036854775807
  START 1
  CACHE 1;
ALTER TABLE import.way_restrictions_id_seq
  OWNER TO postgres;

-- Table: import.way_restrictions

-- DROP TABLE import.way_restrictions;

CREATE TABLE import.way_restrictions
(
  id integer NOT NULL DEFAULT nextval('import.way_restrictions_id_seq'::regclass),
...
ALTER TABLE import.way_restrictions
  OWNER TO postgres;

-- Index: import.from_idx

-- DROP INDEX import.from_idx;

CREATE INDEX from_idx
  ON import.way_restrictions
  USING btree
  (from_id);

-- Index: import.to_idx

-- DROP INDEX import.to_idx;
